    ...
    const ctx = gsap.context((self) => {
      ...
      counters?.forEach((el) => {
        ...
        gsap.fromTo(el, { innerText: 0 }, {
          ...
          onUpdate() { el.textContent = String(Math.round(Number(el.innerText))); },
        });
      });
    }, root);
    return () => ctx.revert();
