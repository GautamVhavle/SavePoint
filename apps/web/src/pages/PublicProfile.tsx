...
import { ArrowUpRight, Check, ChevronDown, Cpu, Gamepad2, MapPin, Medal, Search, Share2, SlidersHorizontal, Star, X } from 'lucide-react';
...
export default function PublicProfile() {
  const [copied,setCopied]=useState(false); const toast=useToast(); const reduce=useReducedMotion();
