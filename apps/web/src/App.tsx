...
const Landing=lazy(()=>import('./pages/Landing'));const PublicProfile=lazy(()=>import('./pages/PublicProfile'));const Dashboard=lazy(()=>import('./pages/Dashboard'));const Editors=lazy(()=>import('./pages/Editors'));const Onboarding=lazy(()=>import('./pages/Onboarding'));const Site=lazy(()=>import('./pages/Site'));
